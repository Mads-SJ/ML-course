...
with open(r'C:\Users\Mads\Desktop\datamatiker\4. semester\ML\ML-code\15_NLP_continued\TrumpSmall.txt','r',encoding='utf-8') as f:
    doc = nlp(f.read())
...
nouns_common_words = nouns_freq.most_common(30)
...
common_words = adjectives_freq.most_common(30)
print(common_words)
...
common_words = tweet_entities_freq.most_common(30)
print(common_words)