...
path_to_aclImdb = r'C:\Users\Mads\Desktop\datamatiker\4. semester\ML\ML-code\15_NLP_sentiment\aclImdb'
with open(path_to_aclImdb + '/imdb.vocab','r',encoding='utf-8')as f:
...
X_train, y_train = load_dataset(path_to_aclImdb + '/train/')
...
print("Load test set:")
X_val, y_val = load_dataset(path_to_aclImdb + '/test/')
